...
function Confession({ onNext }) {
  const boxStyle =
    "bg-white/70 backdrop-blur-md shadow-md rounded-2xl p-6 mb-8 max-w-3xl text-pink-900 border border-pink-200";

  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-pink-100 text-sm sm:text-xxl font-semibold text-center p-6 leading-relaxed overflow-y-auto">
      <div className={boxStyle}>
        Do you remember when I first started calling you baby? 🫣 Our first fight
        was over Chhota Bheem and Ben 10 😂 Then it turned into drama vs anime
        😤🎭 And you—acting all cute and stubborn like a baby—just to win the
        argument 😝 That’s when I started calling you baby ❤️ And
        now….................
      </div>

      <div className={boxStyle}>
        Do you know why I’m not mad (thettal) at you? 😏 Because you can’t
        handle my love ❤️ When I sent you my love rain 🌧️ you caught a fever for
        two days 🤒 My thettal is more powerful and dangerous than my love 💥
        You can’t handle that, my little baby boy 😘💞
      </div>

      <div className={boxStyle}>
        When you said that you think about me when you see a couple feeding each
        other and holding hands… awww, my heart started fluttering like a tiny
        butterfly 🦋💞 You have no idea how sweet that felt from behind the
        phone 😚💖
      </div>

      <div className={boxStyle}>
        When you said even looking at other chicks reminds you of me telling you
        not to… my heart just melted 🥺💗 Little things like that make me love
        you more and more every single time 🦋💞
      </div>

      <div className={`${boxStyle} italic`}>
        I love it when you act a little mad whenever I say ‘bro,’ ‘M,’ or ‘hm’
        😝 It’s honestly adorable… but the moment you call me ‘sis,’ it totally
        kills the vibe 😩💞 And when you say you like to disturb me — ughh, I
        secretly love that too 😚💗
      </div>

      <div className={boxStyle}>
        The scene I imagine the most is being with you at the beach under the
        moonlight — you giving me Dairy Milk Hazelnut, drinking your chikku
        shake, and that tiny fight we had… it’s my favorite memory even if it
        was just in my mind 🥺
      </div>

      <div className={boxStyle}>
        You know what? If I could, I’d erase that whole chapter with Besty from
        your life. I don’t like it — not even a little. The part where she gave
        you Dairy Milk and you gave her a dress? I can’t stand that. And the
        thought of you at the beach with her? I just can’t accept it. She’s the
        one I hate the most, for no reason… maybe just because she was with you
      </div>

      <div className={boxStyle}>
        I don’t like it when you mention other girls 😤 Even when you say you’re
        a mumma’s boy, it makes me a little mad 😅💞 And when you talk about
        that girly tiger, I really don’t like it 😤 So tell me 🤨 — how am I
        supposed to stay calm when you say you notice girls wearing chudidars,
        light makeup, a nose piercing, and natural lips? 😩 Every time you say
        that, I feel like coming over with some Clorox or cleaner to wipe your
        eyes, mind, and heart spotless 😤
      </div>

      <div className={boxStyle}>
        Even on those days when you don’t message me the whole day, it feels
        like something’s missing 😔💗 I know you’re busy, but try telling that
        to my heart too — it just doesn’t listen 🥺💞 Still, I love how you give
        those full explanations before going out or when you get busy — even
        without me asking — like a cute little report 😝 But when I ask you to
        sing and you don’t… that’s the only explanation I can’t accept — it
        makes me a little sad 🥺🎶💞
      </div>

      <div className={`${boxStyle} italic`}>
        I don’t care if it’s your past, Ex, Bestie or another lifetime — you’re
        not allowed to call anyone pretty, beautiful, or gorgeous, baby, ever
        again! 😤💗 And if those eyes even dare to look at someone else without
        permission, I swear I’ll come over and push you straight into a
        pottakinar myself 😆 From now on, those eyes only see me — got it? 😏💞
        Those words belong to me now. They were made only to call your Bubu!
        😚💞
      </div>

      <div className={boxStyle}>
        But the thing I don’t like is how you make me mad and then totally
        forget about it 😤 You know I’m mad, yet you still ask, ‘Kalippilano?’
        like you don’t already know! 😂 You literally know everything — places
        100 km away in Kasaragod, you can reach anywhere without even knowing
        the language 😏 And somehow, without even knowing who those chicks are,
        your eyes still manage to look at them 🙄 But Mr. Genius, you still
        don’t know why I’m mad or the reason behind it… right? 😤💞
      </div>

      <div className={boxStyle}>
        I’ll never forget the day I shared that reel — I felt jealousy burning
        like fire just thinking about those chicks😡🔥. Then you mentioned the
        person I hate the most, your bestie’s name😡😤, and even Hinata — you
        remembered everything about her, and I didn’t like that at all Okay
        BAABBYYY😠
      </div>

      <div className={boxStyle}>
        Do you remember you talked about an aunty who wears a nose piercing and
        said that’s the kind of look you like. You called her cute, beautiful,
        and wonderful — you even said you didn’t have words to describe her🤨. I
        felt so mad at that moment, but I tried to stay calm. But when you said
        that sleep isn’t an issue when you talk to her — that dialogue made me
        lose my mind👺 It drove me crazy😠; Appo anikki neritt vann kannil
        kuthanam nn indarnnn😁 After I got mad and went offline, you probably
        thought I took it too seriously🫣Later, when we sorted things out, you
        didn’t talk to me like you usually do🥹 You went offline early, and
        instead of saying ‘njn or karyam parayatte?’ like you always do, you
        just said you were sleepy😓 and wished me good night. That day, for the
        first time, I felt like I made you sad… like I annoyed or disturbed you
        somehow😔😢
      </div>

      <div className={boxStyle}>
        Then I told you to send a voice note — like you were all shocked 😳
        after hearing my proposal 😝But you didn’t send it! 🥴I even started a
        fight about it 😤 and still, no voice message! 🎙️You knew exactly why I
        was angry 😡💔So tell me… why didn’t you send it, huh? 👀That question
        is still running circles in my mind 🧠💭😂
      </div>
...
But still… I loved the way you acted shocked in your own cute style, my duuuuduuu 😜💗
      ...
      <div className={boxStyle}>
        I already hated your bestie… but then you had to say she’s your only —
        and in that deep voice too! 😤 I don’t even know how mad I got, I swear
        I was ready to come over and put chilli powder in your eyes and mouth
        myself! 🌶️😂 Then you said her song is THARAATT — and you didn’t even
        mention me there, right? 😤 You went to the beach with her, bought her
        ice cream and spring potato, and when she said she was hungry, you even
        got her biriyani?! 😩 Everything else is fine — even the voice call… but
        how could you video call her? 🥹 I can’t accept that one, Dudu. Every
        time that thought pops up in my mind, it makes me feel something I can’t
        even explain 😔💗 And she even taught you cooking — that’s why your
        cooking isn’t that good now and you’ve turned all lazy in cooking 😝🔥💞
      </div>

      <div className={boxStyle}>
        How can you even compare my sweet cutey, my own teddy, with your
        pinky-ponky Bestie? 😤 My teddy is mine forever — always with me, always
        by my side. But your Bestie? Hmm, she’s a little bitter and salty. All
        she can do is video call and voice call — while my teddy stays right
        here, close to my heart 🧸💞
      </div>

      <div className={boxStyle}>
        When I say yes, it can mean no… when I say yes, it can mean yes🤯
        Sometimes yes means maybe😵… and no means no… but sometimes no means
        yes😲… or maybe😳. And maybe can mean yes, or no, or just maybe😵‍💫 — it
        all depends on the situation 🫣 You just have to understand what I really
        mean 😌 I thought you’d say “I can’t understand👀,” but instead you
        said, “I’ll try to understand” — that was so, so sweet of you, babyyy
        🥰😍
      </div>

      <div className={boxStyle}>
        When I said to you, “Kashpettann, I drink water,” you said you don’t😔.
        Then you asked me, “Is there anything else I said that made you
        kashtapaad?🥺” That moment really touched me💘. I didn’t even say what I
        truly felt… I just stayed quiet🤐 but inside, I felt something — a
        little sad, a little heavy💔
      </div>

      <div className={boxStyle}>
        Baby, I really love your voice when you get possessive 😌 but I honestly
        don’t know if you’re actually possessive or just pretending. When I said
        if I have an ex, I had so many stories I could’ve told you — but I loved
        the way you reacted. Even if it wasn’t real, I didn’t expect that
        reaction from you ❤️
      </div>

      <div className={boxStyle}>
        Baby, when I said I decided to voice call, video call, and come to
        Valanchery — that was just to shock you 😌 I didn’t mean to give you
        hope. But honestly, deep inside, I really wanted to do it. I’ve never
        had a love before, so I’ve never done voice or video calls like that —
        maybe that’s why something held me back. But the truth is, I really
        wanted to call you too 💞
      </div>

      <div className={boxStyle}>
        When I heard your first ‘hello’ on the call, my heart started fluttering
        ❤️ and for a moment I couldn’t even breathe 😮‍💨. My voice got stuck on my
        tongue, and when you asked me if I was shy, I actually blushed 🫣. And
        when you smiled… my heart stopped again 💓.That’s when I realized you
        can make my heart flutter and freeze at the same time — even through a
        phone call 🩷📞.And when you said, ‘If you call once, there’s no option
        of not calling again — you have to call,’ that touched me so deeply
        🥹💗.This is exactly how I felt on our first call.
      </div>

      <div className={boxStyle}>
        When you sent that picture of you and your bestie, I was already in a
        bad mood that day 😔. Honestly… I didn’t like her in that moment 😕. I
        was really jealous 🥺💔. You said you were experiencing all this for the
        first time with me, but when you said that you had openly spoken to her
        once, it made me feel something inside 😣. And the way you smiled in
        that picture 😊, and the way you talked about your bestie just to tease
        me… it made me even more jealous 😤💗. I know I reacted too strongly,
        and I’m really sorry for that 🫶🏼🥹
      </div>

      <div className={boxStyle}>
        When I asked you to propose to me, the way you sounded… I liked it so
        much 😘 The way you said, “I didn’t fall but you tried” — nice, baby 😏
        And that “ham haaa mmm” you said… hilarious and so adorable 🤭 I really
        loved it😁 But still… you didn’t propose to me properly 🫤 This time you
        have to do it the right way. I’ll give you one more chance… if you want
        🫣 Will you do it correctly now, baby? 💞😉
      </div>

      <div className={boxStyle}>
        I love your sleepy voice… the way you sound when you’re half-asleep
        melts me completely 😴💗 It gives me a feeling I can’t even put into
        words, baby… it’s like your voice wraps around my heart. And when you
        suddenly stop talking, I miss you instantly 😔❤️ I just want to hear you
        again… even if it’s just one more soft, sleepy word from you.
      </div>

      <div className={boxStyle}>
        I don’t want someone in my life just to wake me up, make me sleep🌙, or
        just text me “gm" and “gn.” I don’t want a connection that’s only about
        voice calls or video calls📱. I want something deeper…❤️ I want someone
        like Gwansik — someone who admired Aesun till her very last breath🫶 I
        want someone who will admire me with that same depth, loyalty, and
        love💗✨
      </div>

      <div className={boxStyle}>
        When you suddenly asked me which flower I like, I just stopped for a
        moment… I didn’t even know how to explain what I felt 🥰 I told you that
        I’m the butterfl🦋and you’re the bouquet💐 so you wouldn’t notice that I
        suddenly got shy🫣
      </div>

      <div className={boxStyle}>
        I got my first kiss on 17/Nov/25 at 9:48 pm😘 Do you want to know
        something, baby😌? I actually got stuck for a few seconds during the
        kiss 🦋 And do you even know… I got shy too🫣 I got that Adivayattil
        Manju Veena feeling 😁— soft, dreamy, magical 🎶💞 And with your sleepy
        voice note 😴💗… your love ❤️… your kiss 😘… awww baby🥰, I can’t even
        explain that feeling 🤯✨ It was just too special🥰
      </div>

      <div className={boxStyle}>
        When I propose to you, I love the way you react through your voice 🥰
        It’s honestly amazing… even I get shy after hearing you 🫣 Every time I
        send you a video, I wait eagerly just to hear you say “Ante mwoleee”
        😍and “njan stuck aayi” 😍 If you don’t say it, I feel like something is
        missing in that video 🥹✨. And today… we talked for 42 minutes 📞💞. I
        enjoyed every second of it — your shy voice 😚, the way you searched for
        words 🤭, the little pauses… everything. Those tiny things are what make
        you my pookie🫰🏻🫶🏻. I also like your once more😁
      </div>

      <div className={boxStyle}>
        When I was angry and I said, “If I caught you in my hand😡…,” you
        suddenly asked me, “Will you give me a kiss?” 😳 I said no… and then you
        said, “Will you hug me?” 🤗 Baby, at that moment I totally lost myself🫣
        Even though it’s just simple words—kiss and hug—when they come from you,
        there’s some kind of magic ✨❤️ Your words hit differently… they touch
        my heart every single time. 💖
      </div>

      <div className={boxStyle}>
        When I told you that I’ll propose to you properly when we meet in
        person,👀 and you said you’ll definitely come, I felt like laughing a
        little 😅❤️ But honestly, the reality is different… I don’t even know if
        I’ll be able to look at you directly 😁 If you ask me whether I want to
        see you or not, I genuinely don’t have an answer 🤐💗. Because if you
        come… everything will change ✨ It won’t be just imagination anymore —
        it will become real 💞🌙.
      </div>

      <div className={boxStyle}>
        The day you were preparing for your exam and presentation, you told me
        you missed me so much🥹… and it felt like many days passed without
        talking to me, even though it was just one night 😔❤️. You said if you
        don’t speak to me at night, your day feels incomplete😘… that your
        morning and night start and end with me 😚✨. You even told me you
        couldn’t sleep that night because we didn’t talk Awww babbyyy🥹… and that
        you only feel relaxed, peaceful, and able to sleep properly after
        speaking to me 😌🤗💞. I read everything… and I know it all came from
        your deepest emotions🥰 Because it was the first time you messaged me
        like that😍🥰😘 And honestly, it made me feel like I’m something magical
        to you… like your fantasy, baby ✨💗. That’s exactly how I felt😍😇
      </div>

      <div className={boxStyle}>
        Baby, when you say you don’t talk to other girls unnecessarily… even
        after working there for 2 years… it makes me sooo happy 😌❤️ It makes me
        feel like I’m truly special to you, like I’m the only one you’re
        connected to 💗 But when you told me you glance at other girls… it
        killed that happiness inside me 💔 I don’t want to control you baby… I
        just want to feel like I’m your only one 🤍🥺
      </div>

      <div className={boxStyle}>
        23 November 2025 is the day you proposed to me… and that day I really
        fell for you 💗✨ Because of the line you said: “imagination alland real
        ayitt njn nighade koode athe bechil nighade kayy pidichond nighade koode
        hazelnut um kazhichond athinte oru kashnam nighalum kazhich inghane
        bechil nighade koode lifelong nadakkan venditt baby varuo nighade koode
        choichille”🥰🙈 Baby, you know one thing… this is the imagination I love
        the most 😘✨ I don’t even like to say this imagination with someone
        else — not even as a joke, not even for teasing 🥹 And baby… the last
        part, the way you gave your hand 🤝😘 I don’t even have to explain how
        it felt… In that moment, I just wanted to grab your hand and hold it
        tight 😘🥰💞 But I couldn’t…🥹😥 And even if you say it for teasing, I
        don’t like it…👊🏻 Because this imagination is only for you and me 🤍😘
        Only with you, baby… always 🫶😘😚😙😗
      </div>

      <div className={boxStyle}>
        Baby, do you know how much these lines mean to me? 🥺💗 When you said:
        “Nink angane mansilakanam n undel enikk aakiyaa madi Njanaan ninde bsty
        , love , ellaaaaam"🥰 "Vere oraalkum ninne vitt kodkilla"😍 "Nee ende
        maatram baby"🥰 "Nee ende ellam aaan"😍 "Enikk nee matre ullu”🥰 Those
        words made me feel like I’m not “one of many”, but the only one in your
        world 🥰🫶🤗
      </div>

      <div className={boxStyle}>
        If I say honestly… I feel insecure when I think about “besty” 😞 It’s
        not because you did something wrong 🥹— you never did anything with your
        ex, I know that…😌 but the way you talked about your besty, the outings,
        pics, gifs… all of that made me insecure each time 💔😭 But when you
        said these lines, I felt better: "Ende lyf l aval oru nalla frnd aayrnu
        atre ullu, not anymore"🤗 "Bsty indaya relationship indavan padilla or
        thirich Randum same tym l paadillaaa"🤗 "Enikk nere samsarikkan
        pattathilla pinnallo idokke , idokke valiyya karyangalan"🤗 "But nammal
        naduvil inganonn illayrnu"🤗 Those words made the insecurity a little
        lighter "Appo video call l nee endaan uddesche 🤨" I don’t want to, but
...
Baby nighal varaatheenn njn sunday nighakk vendi aann vanne paranj adi ayille🥹. Then Monday nighade day valare bad arrnn anikkareelarnn😭. Anikki nallam regret ind athil🥹. Bcz njn athinte idel orupaadd deshyam pidippikum vishamippikum cheyth🥹. But venonn vech cheythathalla 🥹 but ath nighal solve akkaathe kond anghane aayi poyatha🥹. Anne mannichkooongeeeee babyyyy.😭
...
<div className={boxStyle}>
    ...
    "
        >
          I want to tell you one thing… click me with heart ❤️
        </button>
      </div>
    </div>
  );
